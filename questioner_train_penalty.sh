...
# Start vLLM services.  The optional fourth argument is Solver-only; it never
# affects the Questioner actor being trained below.
bash vllm_service_init/start.sh "$solver_model_path" "$RUN_ID" "$solver_lora_path"
